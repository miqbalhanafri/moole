...
<div class="w3-container w3-margin-top w3-medium w3-mobile">
  ...
  <br>
  <div class="w3-center">
    <img src="images/avatar.png" alt="avatar" class="w3-circle" style="width:200px">
  </div>
  <br>
  ...
  <table class="w3-table" style='color:#012641'>
    <tr>
      ...
      <td><p>:</p></td>
      <td><p>miqbalhanafri</p></td>
    </tr>
    <tr>
      <td><p><i class='fas fa-unlock-alt' style='color:#012641'></i></p></td>
  ...
  <div class="w3-center">
  <button type="submit" name="login" class="w3-button w3-section w3-theme-d2 w3-ripple w3-round-xxlarge">Edit</button>
</div>
