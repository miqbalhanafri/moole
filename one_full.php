...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Leaderboard Klasemen Marketing</h1></div>
	</div>
	<div class="w3-row">
...
<!-- Looping for the div table -->
	...
	<div class="w3-row w3-theme-l1">	
	  ...
	  <div class="w3-col w3-container w3-half"><h1 style="color: yellow;">Ranking Update</h1></div>
