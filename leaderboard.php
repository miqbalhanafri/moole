...
<div class="w3-content w3-display-container" style="max-width:900px">
  ...
  <table class="w3-table w3-small">
    <tr class="w3-white">
      ...
      <td><p class="w3-center"><img src="images/trophy1.png" style="width:30px"><br>143400 pts</p></td>
    </tr>
    <tr>
      <td><p><img src="images/avatar.png" class="w3-circle" alt="avatar" style="width:50px"></p></td>
      ...
      <td><p class="w3-center"><img src="images/trophy2.png" style="width:30px"><br>116400 pts</p></td>
    </tr>
    <tr class="w3-white">
      <td><p><img src="images/avatar.png" class="w3-circle" alt="avatar" style="width:50px"></p></td>
      ...
      <td><p class="w3-center"><img src="images/trophy3.png" style="width:30px"><br>102200 pts</p></td>
    </tr>
    <tr>
      <td><p><img src="images/avatar.png" class="w3-circle" alt="avatar" style="width:50px"></p></td>
      ...
      <td><p class="w3-center"><img src="images/trophy.png" style="width:30px"><br>92200 pts</p></td>
    </tr>
    <tr class="w3-white">
      <td><p><img src="images/avatar.png" class="w3-circle" alt="avatar" style="width:50px"></p></td>
      ...
      <td><p class="w3-center"><img src="images/trophy.png" style="width:30px"><br>82200 pts</p></td>
    </tr>
    <tr>
      <td><p><img src="images/avatar.png" class="w3-circle" alt="avatar" style="width:50px"></p></td>
      ...
      <td><p class="w3-center"><img src="images/trophy.png" style="width:30px"><br>72200 pts</p></td>
    </tr>
  </table>
