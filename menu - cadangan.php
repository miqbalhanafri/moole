...
<div class="w3-container">
  ...
  <br>
<a class="w3-bar-item w3-button" href="#"><i class="far fa-calendar-check"></i>&nbsp;&nbsp;Plan</a>
<a class="w3-bar-item w3-button" href="#"><i class="fas fa-stopwatch"></i>&nbsp;&nbsp;Focus</a>
<a class="w3-bar-item w3-button" href="#"><i class="fas fa-award"></i>&nbsp;&nbsp;Rank</a>
<a class="w3-bar-item w3-button" href="three.php"><i class="fas fa-comment"></i>&nbsp;&nbsp;Chat</a>
<a class="w3-bar-item w3-button" href="two.php"><i class="fas fa-user-graduate"></i>&nbsp;&nbsp;Profile</a>
<a class="w3-bar-item w3-button" href="two.php"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;News</a>
