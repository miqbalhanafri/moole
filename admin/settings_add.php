...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Add Job Description and Points</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can add job description and points here</p>
	  </div>
	</div>
	...
	<div class="container">
        <div class="comment">
            <input type="text" class="w3-round-xxlarge" name="points" placeholder="Masukkan points" style="margin-top: 20px;height: 40px; border:none; padding: 10px;">
            <textarea class="textinput w3-round-xxlarge" placeholder="Masukkan informasi job description" type="text" name="jobdesk" style="margin-top: 15px; width: 100%; height: 150px; border:none; padding: 10px;"></textarea>
        </div>
    </div>
	  
	  <button class="w3-button w3-section w3-theme-d3 w3-round-xxlarge w3-ripple" type="submit" name="submit"> Save </button>
	</form>
