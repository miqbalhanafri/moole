...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can edit your informations and instructions to members
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea name="informasi" class="textinput w3-round-xxlarge" rows="3" cols="10" wrap="hard" style="margin-top: 15px; width: 100%; height: 150px; border:none; padding: 10px;"><?= $dataku["informasi"]; ?></textarea>
        </div>
    </div>
