...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Edit user of AmalQu App</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can edit the users of the AmalQu App</p></div>
	</div>
...
<?php foreach ( $username as $row ) : ?>
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="one_edit.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-theme-d1 w3-ripple"><i class='far fa-edit' style='font-size:24px'></i></a><a href="one_delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-theme-d1 w3-ripple"><i class='far fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
