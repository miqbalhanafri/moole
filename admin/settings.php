...
$tampil = query("SELECT * FROM marketing");
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Setting of Job Description and Points</a></h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can create some job description and points by the level of difficulties</p></div>
	</div>

	<div class="w3-row w3-theme-d1">
	<div class="w3-col w3-container w3-half"><h1 style="color: yellow;">Job Description</h1></div>
	<div class="w3-col w3-container w3-half"><h1 style="color: yellow;">Points</h1></div>
	</div>
...
<?php foreach ( $tampil as $row ) : ?>
		...
		<?php endif; ?>
		<!-- End div -->
	  <div class="w3-col w3-container w3-half"><p><?= $i; ?>. <?= $row["jobdesk"]; ?></p></div>
	  <div class="w3-col w3-container w3-quarter"><h1><?= $row["points"]; ?></h1></div>
	  <div class="w3-col w3-container w3-quarter"><a href="settings_edit.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-theme-d1 w3-ripple"><i class='far fa-edit' style='font-size:24px'></i></a><a href="settings_delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-theme-d1 w3-ripple"><i class='far fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
...
<!-- End looping for the div table -->
	...
	<div class="w3-row">
		...
		<a href="settings_add.php" class="w3-button w3-section w3-theme-d3 w3-ripple w3-round-xxlarge">Add jobdesk</a>  &nbsp<a href="menu.php" class="w3-button w3-section w3-theme-d3 w3-ripple w3-round-xxlarge"><i class='fas fa-undo'></i></a></div>
	</div> 
</div>
